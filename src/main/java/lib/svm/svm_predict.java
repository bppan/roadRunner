...
public class svm_predict {
	...
	public static double[] predictSingle(svm_model model, String feature){
		...
		{
			System.err.println("svm type is wrong!");
			System.exit(1);
		}
		double[] label_pro = new double[2];
		label_pro[0] = v;
		label_pro[1] = max_prob;
		return label_pro;
	}
